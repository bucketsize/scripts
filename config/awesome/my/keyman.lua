...
function Keyman:keys_global()
	local globalkeys = gears.table.join(
		...
		awful.key({ modkey,           }, "w", function () self.ctx.mymainmenu:show() end,
...
function Keyman:buttons_client()
...
function Keyman:buttons_global()
	return gears.table.join(
		awful.button({ }, 3, function () CTX.mymainmenu:toggle() end),
